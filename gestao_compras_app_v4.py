...
st.set_page_config(
    page_title="PGI - Gestão de Cotações v4",
    page_icon="💼",
    layout="wide",
...
# --- TELA PRINCIPAL (APÓS LOGIN) ---
    ...
    with st.sidebar:
        ...
        st.markdown(f"👤 <strong>Comprador Ativo:</strong><br><span style='color: #FF6F00; font-weight: bold;'>{st.session_state.user}</span>", unsafe_allow_html=True)
    ...
    # PAGE 4: DETALHES DE INTEGRAÇÃO DO SHAREPOINT E OAUTH2
        ...
        st.markdown("""
        O aplicativo v4 está pareado com o arquivo de suporte <code>sharepoint_auth.py</code> para fazer a comunicação direta sem dependências complexas externas. Ele utiliza o fluxo seguro de <strong>Client Credentials</strong> do OAuth2.
